...
- build a technical implementation every week;
- document each weekly build in a GitHub repository;
- show the build in class; and
- present the technical details of the implementation in class.
