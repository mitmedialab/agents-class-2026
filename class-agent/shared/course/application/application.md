...
| Field | Value |
| --- | --- |
| Capacity | 25 in-person students |
...
| Acceptance notification | Monday, September 9, midnight |
...
13. Submit only after every required field and photo is present and the applicant explicitly approves the complete application.
14. Before submission, present all data that will be submitted and let the user suggest edits or approve it.
15. After submission, tell them when they will know if they are accepted.
