...
**Teaching support:** Chitralekha Gupta, Rachel Poonsiriwong, Sheer Karny, Wazeer Zulfikar, Yasith Samaradivakara
...
Students will learn to build agents using state-of-the-art large language models and frameworks, connect agents to multimodal inputs, design test environments, fine-tune and improve agent behavior, and critically evaluate how agents can integrate with or disrupt human cognitive processes. The course will treat agents not as a single technology, but as a broad design space: agents that play video games, operate machines or robots, manage calendars, browse the web, control software, coordinate organizations, build code, improve websites, run simulated businesses, or assist humans in thinking, learning, and decision-making.

The course will ask a central question: **how can agents augment human cognitive abilities rather than replacing or weakening them?** Alongside technical agent-building, students will study how AI agents affect attention, memory, learning, reasoning, creativity, agency, and social behavior. A dedicated module will focus on BCIs, wearables, and physiological sensing, giving students hands-on experience building agents that respond to human cognitive and bodily signals.

## **Motivation**

AI agents are becoming one of the defining applications of artificial intelligence. Yet the field is still young: current agents are powerful but brittle, impressive but unreliable, increasingly autonomous but poorly understood. This creates a rare educational opportunity. Rather than only teaching established techniques, the course will function as an experimental studio and technical lab for discovering what agents can do today, where they fail, and how they might be designed more responsibly.

The Media Lab is uniquely positioned to host this course. The Lab has a long history of work on software agents, human augmentation, wearable computing, and human-centered AI. Co-taught with Pattie Maes, whose work helped define the field of software agents, the course will connect this history to the current frontier of LLM-based, multimodal, embodied, and socially embedded agents.
...
Students will be evaluated through a sequence of open-ended, weekly technical implementations, documentation on their agentic website, in-class demos, peer critique, and a final project or study. The emphasis will be on working systems, thoughtful experimentation, clear documentation, and honest analysis of limitations.

Each assignment will ask students to demonstrate a specific technical skill while leaving the application domain open. For example, after learning tool-calling and memory, one student might build a calendar agent, another might build a game-playing agent, and another might build a research assistant that updates a website. After the multimodal module, one student might build a gaze-aware reading assistant while another builds an agent that responds to sound, movement, or visual context.

For the final projects, students will work in small groups and build a functioning, novel agent application or technique. They will also document the why, what, how of their project. The final project will be evaluated based on both its novelty and strength of the idea as well as on its execution, completion and writeup.

| Component | Weight |
| :---- | :---- |
| Weekly technical builds | 35% |
| Agentic website / documentation | 15% |
